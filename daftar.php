				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						if (isset($_POST["daftar"])) 
						{
							...
							// cek apakah email sudah digunakana
							...
							else
							{
								...
								$koneksi->query("INSERT INTO pelanggan(email_pelanggan,password_pelanggan,nama_pelanggan,telpon_pelanggan,alamat_pelanggan) VALUES ('$email','$password','$password','$telepon','$alamat')");
